...
abstract class _JsUtils implements InjectionAwareInterface {
	 ...
	 *        	javascript code to execute after the request
	 */
	 ...
	 *        	the request url
	 * @param string $params
	 *        	Paramètres passés au format JSON
	 * @param string $method
	 *        	Method used
	 * @param string $jsCallback
	 *        	javascript code to execute after the request
	 ...
	 *        	default : array("preventDefault"=>true,"stopPropagation"=>true,"params"=>"{}","jsCallback"=>NULL,"attr"=>"id")
	 */
	 ...
	 *        	selector of the HTML element displaying the answer
	 * @param array $parameters
	 *        	default : array("preventDefault"=>true,"stopPropagation"=>true,"jsCallback"=>NULL,"attr"=>"id")
	 */
	 ...
	 *        	selector of the HTML element displaying the answer
	 * @param array $parameters
	 *        	default : array("preventDefault"=>true,"stopPropagation"=>true,"validation"=>false,"jsCallback"=>NULL,"attr"=>"id")
	 */
	 ...
	 * @param string $param        	
	 * @param array $parameters
	 *        	default : array("preventDefault"=>false,"stopPropagation"=>false,"jsCallback"=>'')
	 */
	 ...
	 *        	Code to execute
	 * @param array $parameters
	 *        	default : array("preventDefault"=>false,"stopPropagation"=>false)
	 * @return String
	 */
