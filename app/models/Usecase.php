...
class Usecase extends BaseModel {
	...
	public function initialize() {
		$this->hasMany ( 'code', 'Tache', 'codeUseCase', array (
				'alias' => 'Tache' 
		) );
		$this->belongsTo ( 'idProjet', 'Projet', 'id', array (
				'alias' => 'Projet' 
		) );
		$this->belongsTo ( 'idDev', 'User', 'id', array (
				'alias' => 'User' 
		) );
	}
	...
	public function toString() {
		return $this->nom . " - " . $this->Projet->getNom() . " - " . $this->User->getIdentite() ;
	}
