...
{{ form("Connexion/connexion", "method": "post", "name":"frmObject", "id":"frmObject") }}
	...
	<center><input type='password' id='mdp' name='mdp' required='required' style='width:225px; border:1px solid rgb(129,181,221); text-align:center; border-radius:1px; height:30px;'></center> </br></br>
