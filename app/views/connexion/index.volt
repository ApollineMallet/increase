<!DOCTYPE html>
<html>
{{ form("Connexion/", "method": "post", "name":"frmObject", "id":"frmObject") }}
	...
	<center> <button class='btn btn-primary add' data-ajax="{{"index"}}" style='width:225px;'> Me connecter </button> </center>
</form>
</html>