...
<p>
	You can now install <a href="http://phalcon-jquery.kobject.net"
		target="new">phalcon-jQuery</a> for flying even faster.
</p>
<a class="btn btn-default" href="{{url.get("
	Users")}}" data-ajax="Users">Utilisateurs</a>
&nbsp;
<a class="btn btn-primary" href="{{url.get("
	Projects")}}" data-ajax="Projects">Projets</a>
&nbsp;


<a class="btn btn-success" href="{{url.get("
	UseCases")}}" data-ajax="UseCases">UseCases</a>
&nbsp;
...
<a class="btn btn-warning" href="{{url.get("
	Messages")}}" data-ajax="Messages">Messages</a>
&nbsp;
