...
<table class='table table-striped'>
	<thead><tr><th colspan='3'>{{model}}</th></tr></thead>
		...
		{% for object in objects %}
			...
			<td class='td-center'><a href='{{url.get(baseHref~"/show/"~object.getId())}}' data-ajax="{{ baseHref ~ "/show/" ~ object.getId() }}" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-eye-open"></span></a></td>
