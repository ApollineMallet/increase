<div style="padding:0px 40px 10px 40px;">
	...
	<div style="padding:20px 0px 10px 80px; display:block;">
		...
		<textarea placeholder=" Contenue..." style="width:100%; max-width:100%; border-radius:2px;"></textarea>
		
		<input type="submit" value="Valider" class="btn" style='margin-top:25px; border:1px solid #5B81D8; width:15%; display:block; border-radius:2px; background-color:#A3C0FF; cursor:pointer;'>
