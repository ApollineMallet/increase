...
<fieldset>
	...
	<div class="form-group">
		...
		<input type="text" name="identite" id="identite"
			value="{{user.getIdentite()}}" placeholder="Entrez votre identité"
			class="form-control"> <input type="mail" name="mail"
			id="mail" value="{{user.getMail()}}"
			placeholder="Entrez l'adresse email" class="form-control"> <input
			type="password" name="password" id="password"
			value="{{user.getPassword()}}" placeholder="Entrez le mot de passe"
			class="form-control"> {{ q["role"] }}
	</div>
