...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 16 Décembre 2015 à 21:31
...
(128, 3, 'Acl', 'update', 1),
(129, 3, 'Acl', 'index', 1),
(130, 3, 'Acl', 'updatedroit', 1),
(131, 3, 'Acl', 'updaterole', 1),
(132, 3, 'Role', 'index', 1),
(134, 3, 'Role', 'update', 1),
(135, 3, 'users', 'updaterole', 1);
...
(7, 'Ok', 'Rien ', '2015-03-13 13:33:51', 2, 1, 2);
...
(1, 'Interview client +r', '2015-03-22', 100, 'I-UC1'),
(2, 'MCD', '2015-03-22', 100, 'I-UC2'),
(3, 'G', '2015-03-22', 100, 'I-UC3'),
(4, 'Uses cases', '2015-03-23', 100, 'I-UC4'),
(5, 'Connexion RESTj', '2015-03-13', 50, 'OB-UC1'),
(6, 'Liste des bi', '2015-03-22', 100, 'OB-UC2'),
(7, 'Liste des bii', '2015-03-22', 10, 'OB-UC2');
...
('I-UC-Dev5', 'Laisser un message, r', 2, 0, 1, 4),
('I-UC-Dev6', 'Saisir l''anvancement d''un Use case', 5, 0, 1, 4),
('I-UC-Dev7', 'Saisir une t', 2, 0, 1, 4),
('I-UC-Dev8', 'Se d', 2, 0, 1, 2),
('I-UC-Dev9', 'Lister les messages (nouveaux, archiv', 2, 0, 1, 2),
('I-UC1', 'R', 2, 100, 1, 2),
('I-UC2', 'Analyse des donn', 2, 100, 1, 2),
('I-UC3', 'Base de donn', 2, 100, 1, 2),
('I-UC4', 'Analyse fonctionnelle', 20, 100, 1, 4),
('OB-UC1', 'Connexion au server REST', 10, 50, 2, 5),
('OB-UC2', 'Gestion des bi', 10, 55, 2, 5);
...
(1, 'jcheron@kobject.net', 'ffffff9afffffff15b336e6affffff9619ffffff92ffffff8537ffffffdf30ffffffb2ffffffe6ffffffa2376569fffffffcfffffff9ffffffd7ffffffe773ffffffecffffffceffffffde65606529ffffffa0', 'JC HERON', 3),
...
(4, 'misko.hevery@gmail.com', 'ffffff9afffffff15b336e6affffff9619ffffff92ffffff8537ffffffdf30ffffffb2ffffffe6ffffffa2376569fffffffcfffffff9ffffffd7ffffffe773ffffffecffffffceffffffde65606529ffffffa0', 'Mi', 1),
(5, 'pete.bacon@gmail.com', 'ffffff9afffffff15b336e6affffff9619ffffff92ffffff8537ffffffdf30ffffffb2ffffffe6ffffffa2376569fffffffcfffffff9ffffffd7ffffffe773ffffffecffffffceffffffde65606529ffffffa0', 'Pete Bacon Darwin', 1),
...
(10, 'admin@gmail.com', 'ffffff9afffffff15b336e6affffff9619ffffff92ffffff8537ffffffdf30ffffffb2ffffffe6ffffffa2376569fffffffcfffffff9ffffffd7ffffffe773ffffffecffffffceffffffde65606529ffffffa0', 'admin', 1);
...
ALTER TABLE `acl`
  ADD PRIMARY KEY (`id`),
  ADD KEY `nom_ressource` (`nom_ressource`),
  ADD KEY `nom_action` (`nom_action`),
  ADD KEY `nom_action_2` (`nom_action`),
...
--
ALTER TABLE `action`
  ADD PRIMARY KEY (`nom_action`,`nom_ressource`),
  ADD KEY `nom_ressource` (`nom_ressource`);
